...
public class TerminalDataController {
    ...
    public void Test() {
        ...
        ruleTemplate(WebDataController.threshold[0],WebDataController.parameterName[0],WebDataController.symbol[0],WebDataController.operation[0],WebDataController.service[0],WebDataController.device[0],WebDataController.scenario[0],flag0,
                WebDataController.threshold2[0],WebDataController.parameterName2[0],WebDataController.symbol2[0],WebDataController.threshold3[0],WebDataController.parameterName3[0],WebDataController.symbol3[0]);
        ruleTemplate(WebDataController.threshold[1],WebDataController.parameterName[1],WebDataController.symbol[1],WebDataController.operation[1],WebDataController.service[1],WebDataController.device[1],WebDataController.scenario[1],flag1,
                WebDataController.threshold2[1],WebDataController.parameterName2[1],WebDataController.symbol2[1],WebDataController.threshold3[1],WebDataController.parameterName3[1],WebDataController.symbol3[1]);
        ruleTemplate(WebDataController.threshold[2],WebDataController.parameterName[2],WebDataController.symbol[2],WebDataController.operation[2],WebDataController.service[2],WebDataController.device[2],WebDataController.scenario[2],flag2,
                WebDataController.threshold2[2],WebDataController.parameterName2[2],WebDataController.symbol2[2],WebDataController.threshold3[2],WebDataController.parameterName3[2],WebDataController.symbol3[2]);
        ruleTemplate(WebDataController.threshold[3],WebDataController.parameterName[3],WebDataController.symbol[3],WebDataController.operation[3],WebDataController.service[3],WebDataController.device[3],WebDataController.scenario[3],flag3,
                WebDataController.threshold2[3],WebDataController.parameterName2[3],WebDataController.symbol2[3],WebDataController.threshold3[3],WebDataController.parameterName3[3],WebDataController.symbol3[3]);
        ruleTemplate(WebDataController.threshold[4],WebDataController.parameterName[4],WebDataController.symbol[4],WebDataController.operation[4],WebDataController.service[4],WebDataController.device[4],WebDataController.scenario[4],flag4,
                WebDataController.threshold2[4],WebDataController.parameterName2[4],WebDataController.symbol2[4],WebDataController.threshold3[4],WebDataController.parameterName3[4],WebDataController.symbol3[4]);
        ruleTemplate(WebDataController.threshold[5],WebDataController.parameterName[5],WebDataController.symbol[5],WebDataController.operation[5],WebDataController.service[5],WebDataController.device[5],WebDataController.scenario[5],flag5,
                WebDataController.threshold2[5],WebDataController.parameterName2[5],WebDataController.symbol2[5],WebDataController.threshold3[5],WebDataController.parameterName3[5],WebDataController.symbol3[5]);
        ruleTemplate(WebDataController.threshold[6],WebDataController.parameterName[6],WebDataController.symbol[6],WebDataController.operation[6],WebDataController.service[6],WebDataController.device[6],WebDataController.scenario[6],flag6,
                WebDataController.threshold2[6],WebDataController.parameterName2[6],WebDataController.symbol2[6],WebDataController.threshold3[6],WebDataController.parameterName3[6],WebDataController.symbol3[6]);
        ruleTemplate(WebDataController.threshold[7],WebDataController.parameterName[7],WebDataController.symbol[7],WebDataController.operation[7],WebDataController.service[7],WebDataController.device[7],WebDataController.scenario[7],flag7,
                WebDataController.threshold2[7],WebDataController.parameterName2[7],WebDataController.symbol2[7],WebDataController.threshold3[7],WebDataController.parameterName3[7],WebDataController.symbol3[7]);
        ruleTemplate(WebDataController.threshold[8],WebDataController.parameterName[8],WebDataController.symbol[8],WebDataController.operation[7],WebDataController.service[8],WebDataController.device[8],WebDataController.scenario[8],flag8,
                WebDataController.threshold2[8],WebDataController.parameterName2[8],WebDataController.symbol2[8],WebDataController.threshold3[8],WebDataController.parameterName3[8],WebDataController.symbol3[8]);
        ruleTemplate(WebDataController.threshold[9],WebDataController.parameterName[9],WebDataController.symbol[9],WebDataController.operation[8],WebDataController.service[9],WebDataController.device[9],WebDataController.scenario[9],flag9,
                WebDataController.threshold2[9],WebDataController.parameterName2[9],WebDataController.symbol2[9],WebDataController.threshold3[9],WebDataController.parameterName3[9],WebDataController.symbol3[9]);

        kieSession.dispose();
    }
    public void ruleTemplate (int OutThreshold,String name,String symbol,String operation,String service, String device,String scenario, int flag1, int OutThreshold2,String name2,String symbol2, int OutThreshold3,String name3,String symbol3)
    {
        int Flag2=0;
        int Flag3=0;
        if(name==null)
